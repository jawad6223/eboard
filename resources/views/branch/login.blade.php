...
Invalid Credentials 
   ...
   @endif
                        ...
                        <form class="theme-form" action="{{url('branch/login_action')}}" method="post">
                           @csrf
                    ...
                    @enderror
                           ...
                           <div class="form-group mb-0">
                              ...
                              <a class="link" href="{{ url('/branch/forget') }}">Forgot password?</a>
                              <div class="text-end mt-3">
                                 <button class="btn btn-primary btn-block w-100" type="submit">Sign in</button>
                              </div>
                           </div>
                           <p class="mt-4 mb-0 text-center">Don't have account?<a class="ms-2" href="{{ url('/branch/signup') }}">Create Account</a></p>
