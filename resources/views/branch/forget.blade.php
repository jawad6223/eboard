                  ...
                  <div class="login-card">
                     <div>
                        ...
                        <div class="login-main">
                           ...
                           <form class="theme-form "  method="post" action="{{url('branch/forget_action')}}">
                               @csrf
                                  @if (session('message1'))
             ...
             Email does not match try again
              ...
              <span class="text-danger">
               ...
               @endif
                              ...
                              <p class="mt-4 mb-0 text-center">Already have an password?<a class="ms-2" href="{{url('/branch/login')}}">Sign in</a></p>
                           </form>
                        </div>
                     </div>
                  </div>
